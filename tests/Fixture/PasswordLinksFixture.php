...
/**
 * PasswordLinksFixture
 *
 */
class PasswordLinksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'used' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_indexes' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'user_id' => 1,
                'uuid' => '4cf17294-60e9-4b1f-946a-be952be180e7',
                'created' => '2018-11-19',
                'used' => 1
            ],
        ];
